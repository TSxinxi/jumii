...
export function getLanguage() {
  ...
  let language = {
    ...
    SA: {
      ...
      phonepl2: 'رقم الواتس اب: 5xxxxxxxx',
      comments: 'ملاحظات',
    ...
    HUF: {
      ...
      address: "Utcanév",
      addressPle: "pl.: Központi út",
      postalCode: 'Irányítószám',
      h0u31n: "Házszám",
      h0u31Pl1: "Házszám, háztömb, lépcső, emelet, lakás",
    ...
    CZK: {
      ...
      address: 'Jméno ulice',
      addressPle: "např.: Centrální silnice",
      postalCode: 'PSČ',
      h0u31n: "Číslo domu",
      h0u31Pl1: "Číslo domu, blok, schodiště, patro, byt",
    ...
    zł: {
      ...
      address: "Nazwa ulicy",
      addressPle: "np.: Droga centralna",
      postalCode: 'Kod pocztowy',
      h0u31n: "Numer domu",
      h0u31Pl1: "Numer domu, blok, schody, piętro, mieszkanie",
    ...
    EUR: {
      ...
      address: "Ονομα δρόμου",
      addressPle: "π.χ.: Κεντρικός δρόμος",
      postalCode: "Ταχυδρομικός κώδικας",
      h0u31n: "Τον αριθμό του σπιτιού",
      h0u31Pl1: "Αριθμός σπιτιού, Μπλοκ, Σκάλα, Όροφος, Διαμέρισμα",
